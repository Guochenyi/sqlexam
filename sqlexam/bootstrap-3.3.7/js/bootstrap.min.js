    ...
    var ms = {
        ...
        fillHtml:function(totalsubpageTmep,args){
            return (function(){
                ...
                /* 添加« */
               	if(args.currPage == 1) {
               		totalsubpageTmep += "<li class='disabled'><a href='javascript:void(0);' class='up-page' data-go='' ><span aria-hidden='true'>«</span></a></li>";
               	}
                else {
                	totalsubpageTmep += "<li class='ali'><a href='javascript:void(0);' class='up-page' data-go='' ><span aria-hidden='true'>«</span></a></li>";
                }
                ...
                for(; start<=end; start++) {
                    if(start<=args.totalPage && start>=1) {
                    	if(start == args.currPage) {
                    		totalsubpageTmep += "<li class='ali active'><a href='javascript:void(0);' class='geraltTb_pager' data-go='' >"+start+"</a></li>";
                    	}
                    	else {
                ...
                if(args.currPage == args.totalPage) {
                	totalsubpageTmep += "<li class='disabled'><a href='javascript:void(0);' class='down-page' data-go='' ><span aria-hidden='true'>»</span></a></li>";
                }
                else {
                	totalsubpageTmep += "<li class='ali'><a href='javascript:void(0);' class='down-page' data-go='' ><span aria-hidden='true'>»</span></a></li>";
                }
        ...
        bindEvent:function(totalsubpageTmep,args){
            return (function(){
                ...
                totalsubpageTmep.on("click","a.up-page",function(event){
                    args.backFn(parseInt($(".pagination").children(".active").text()) - 1);
                });
                totalsubpageTmep.on("click","a.down-page",function(event){
                    args.backFn(parseInt($(".pagination").children(".active").text()) + 1);
                });
            })();
        }
